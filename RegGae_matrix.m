function [T, S, Q, Z, C, Dd, SSd, st, p, j, Ast, SSst, Dst]=RegGae_matrix(model)
...
% Function runs Dynare for 'model', extracts its Jacobian, steady-state and shock matrices.
...
try 
dynare_file=[model '.mod'];
evalc(['dynare ' dynare_file ]);
catch
end
